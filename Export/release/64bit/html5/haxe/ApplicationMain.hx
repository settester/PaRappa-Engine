...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PaRappaEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PaRappaEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PaRappaEngine";
		app.meta["name"] = "ParappaEngine";
		app.meta["packageName"] = "com.sample.parappaengine";
		...
		#elseif air
		app.window.title = "ParappaEngine";
		#else
